      ...
      <Container>
        ...
        {/* <div className="container mx-auto"> */}
          <div className="flex items-center">
            ...
            <div className={`lg:w-7/12 w-full bg-gradient-to-b from-gray-600 to-gray-900 lg:bg-none lg:static top-0 h-full lg:h-auto lg:p-0 fixed p-10 transition-all ${offCanvas ? 'left-0' : '-left-full'}`}>
            ...
            <div className={`lg:w-3/12 absolute w-full left-0 lg:static transition-all ${search ? 'top-10 px-10' : '-top-40'}`}>
              ...
              <input type="text" className="bg-gray-700 py-4 px-6 w-full lg:rounded-full rounded-lg bg-search pl-12" placeholder="Search..." />
            </div>
          </div>
        {/* </div> */}
      </Container>
